This ``Automatic-AC-Machine`` is designed to **copy** the **passed** code from one OJ to another OJ For OJs using ``RemoteJudge`` , the number of submissions can be synchronized.
